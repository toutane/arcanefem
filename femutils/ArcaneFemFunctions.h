 ...
 public:
  ...
  class MeshOperation
  {
   ...
   public:
    ...
    ARCCORE_HOST_DEVICE
    static inline Real computeVolumeTetra4HostDevice(CellLocalId icell, const IndexedCellNodeConnectivityView& cnc, const ax::VariableNodeReal3InView& in_node_coord)
    {
      Real3 vertex0 = in_node_coord[cnc.nodeId(icell, 0)];
      Real3 vertex1 = in_node_coord[cnc.nodeId(icell, 1)];
      Real3 vertex2 = in_node_coord[cnc.nodeId(icell, 2)];
      Real3 vertex3 = in_node_coord[cnc.nodeId(icell, 3)];
